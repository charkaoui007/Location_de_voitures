...
from .views import (car_list_view, car_view, BookingView, BookingListView, AllCarsListView, CancelBookingView,
                    BookingNotAvail)
...
urlpatterns = [
    ...
    path('bookingnotava', BookingNotAvail.as_view(), name="bookingnotava"),
